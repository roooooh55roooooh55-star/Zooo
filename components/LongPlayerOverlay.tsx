        ...
        <div className="flex-grow flex flex-col p-6 gap-6 overflow-hidden">
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <button onClick={onDislike} className={`py-4 rounded-[1.5rem] border-2 transition-all flex justify-center items-center ${isDisliked ? 'neon-btn-red bg-red-600/30' : 'bg-white/5 border-white/10 text-white hover:neon-btn-red'}`}>
              ...
              <button onClick={onSave} className={`py-4 rounded-[1.5rem] border-2 transition-all flex justify-center items-center ${isSaved ? 'neon-btn-yellow bg-yellow-500/30' : 'bg-white/5 border-white/10 text-white hover:neon-btn-yellow'}`}>
              ...
              <button onClick={() => setIsMuted(!isMuted)} className={`py-4 rounded-[1.5rem] border-2 transition-all flex justify-center items-center ${isMuted ? 'neon-btn-red bg-red-600/30' : 'bg-white/5 border-white/10 text-white hover:neon-btn-purple'}`}>
